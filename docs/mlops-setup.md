...
git add README.md docs .gitignore nyc_taxi/resources/README.md
...
* You must be a Databricks workspace admin in the staging and prod workspaces. Verify that you're an admin by viewing the
  [staging workspace admin console](https://adb-1953183030701099.19.azuredatabricks.net#setting/accounts) and
  [prod workspace admin console](https://adb-467938697631573.13.azuredatabricks.net#setting/accounts). If
...
If you want to use different catalog names, please update the target names declared in the[nyc_taxi/databricks.yml](../nyc_taxi/databricks.yml) file.
...
Follow the instructions in [nyc_taxi/resources/README.md](../nyc_taxi/resources/README.md) to deploy ML resources
and production jobs.
...
[ML resource config guide](../nyc_taxi/resources/README.md)  to propose, test, and deploy
