...
Opening a pull request will trigger a[workflow](../.github/workflows/nyc_taxi-run-tests.yml) 
...
Links:
* [Staging model in UC](https://adb-1953183030701099.19.azuredatabricks.net/explore/data/models/staging/nyc_taxi/nyc_taxi-model)
* [Prod model in UC](https://adb-467938697631573.13.azuredatabricks.net/explore/data/models/prod/nyc_taxi/nyc_taxi-model)
. 
